...
let { load, add, change, remove } = require('../controllers/basket_controller');


let router = express.Router();

router.get('/shop/:id', load);
router.post('/shop/:id', add);
router.put('/shop/:id', change);
router.post('/shop/:id/delete', remove);
